...
public final class Constants
{
	...
	private static final String EXPLORE_BASE_URL_PROD = "http://explorer.zeitcoinofficial.com/";
	private static final String EXPLORE_BASE_URL_TEST = "http://explorer.zeitcoinofficial.com/testnet/";
	...
	private static final String BITEASY_API_URL_PROD = "http://explorer.zeitcoinofficial.com/";
	private static final String BITEASY_API_URL_TEST = "http://explorer.zeitcoinofficial.com/testnet/";
	...
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-zeitcoin-wallet-backup";

	/** Number of confirmations until a transaction is fully confirmed. */
	public static final int MAX_NUM_CONFIRMATIONS = 7;

	/** User-agent to use for network access. */
	public static final String USER_AGENT = "zeitcoin Wallet";

	/** Default currency to use if all default mechanisms fail. */
	public static final String DEFAULT_EXCHANGE_CURRENCY = "USD";

	/** Donation address for tip/donate action. */
	public static final String DONATION_ADDRESS = "MgNKk73sP6q2XgT3beU7WV9SKppVGTGa2w";

	/** Recipient e-mail address for reports. */
	public static final String REPORT_EMAIL = "roboguy3@gmail.com";
	...
	public static final String SOURCE_URL = "https://github.com/zeitcoinCommunity/zeitcoin-wallet";
	public static final String BINARY_URL = "https://github.com/zeitcoinCommunity/zeitcoin-wallet/releases";
